...
void main() {
  ...
  runApp(const formul_10());
}

class formul_10 extends StatelessWidget {
  const formul_10({super.key});
          ...
          child: Column(
            //mainAxisAlignment: MainAxisAlignment.center, //Butonların konumunu belirler.
              children: <Widget>[
                ...
                Image(
                  image: AssetImage("assets/resimler/on_1.png"),
                  width: 900,
                  height: 200,
                ),
                Divider(
                ...
                Image(
                  image: AssetImage("assets/resimler/on_2.png"),
                  width: 900,
                  height: 100,
                ),
                Divider(
